...
async def test_graph_batch_operations(storage):
    ...
    try:
        ...
        # Verified by neo4j that it should be 4, however in networkx it is 2.
        # TODO: report this to lightrag
        assert len(edges) == 4, f"{chunk2_id} 应有2条边，实际有 {len(edges)} 条"
        ...
        # Verified by neo4j that it should be 6, however in networkx it is 3.
        # TODO: report this to lightrag
        assert (
            len(edges) == 6
